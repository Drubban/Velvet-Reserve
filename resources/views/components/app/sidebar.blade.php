<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ request()->is('reservations*') ? '' : 'collapsed' }}" data-bs-toggle="collapse"
                    href="#reservationsMenu" role="button"
                    aria-expanded="{{ request()->is('reservations*') ? 'true' : 'false' }}"
                ...
                <div class="collapse {{ request()->is('reservaciones*') ? 'show' : '' }}" id="reservationsMenu">
                    <ul class="nav ms-4 ps-2 flex-column">
                        <li class="nav-item">
                            <a class="nav-link {{ is_current_route('reservaciones.index') ? 'active' : '' }}"
                                href="{{ route('reservaciones.index') }}">
                                Ver todas
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ is_current_route('reservaciones.show') ? 'active' : '' }}"
                                {{-- href="{{ route('reservaciones.show', ['reservation' => 1]) }}"> --}}
                                Ver individual
                            </a>
                        </li>
                    </ul>
